      ...
      <div className="flex flex-col sm:flex-row gap-6 md:gap-10">
        <div className="w-full sm:w-[45%]">
          <div className="flex items-center flex-col">
            ...
            <SectionHeader
              title="Get In Touch"
              styles="text-2xl sm:text-3xl lg:text-4xl pb-5"
            />
          </div>
          ...
          <div className="flex flex-col gap-6 border-b pb-10">
            <div className="flex gap-4">
              <div className="bg-[#fdeae5] p-5 rounded-full">
            ...
            <div className="flex gap-4">
              <div className="bg-[#fdeae5] p-5 rounded-full">
                <IoIosMailOpen className="text-red-500 text-2xl" />
              </div>
              <div className="flex flex-col justify-between">
                <h4 className="text-lg md:text-xl text-[#787878] font-semibold">
                  Phone Call
          ...
          <div className="py-5 flex flex-col lg:flex-row gap-4 items-center justify-between">
          ...
          <form className="flex flex-col gap-6">
            ...
            <div className="relative w-full">
              <input
                ...
                required
              />
              <AiOutlineSelect className="absolute left-4 top-[13px] sm:top-[16px] text-red-500 w-5 h-6" />
            </div>
            <div className="relative w-full">
              <textarea
            ...
            <button
              type="submit"
              className="flex justify-center items-center gap-4 hover:gap-6 text-white bg-[#EB3300] hover:bg-[#d13509] duration-200 text-center py-[12px] sm:py-[14px] rounded-md"
            >
