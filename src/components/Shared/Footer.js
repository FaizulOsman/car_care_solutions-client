        ...
        <div className="w-11/12 max-w-[1200px] mx-auto pt-5">
          <div className="flex flex-wrap px-6 pt-14">
            <div className="w-full sm:w-[50%] lg:w-[27%] pr-4 mb-6">
              ...
              <h4 className="text-md sm:text-lg">WE ARE AVAILABLE</h4>
              <p className="text-[#8b8e95] mb-6">
            ...
            <div className="w-full sm:w-[50%] lg:w-[19%] pr-4 mb-6">
              ...
              <Link
                href="/about-us"
                className="text-[#8b8e95] hover:text-[#EB3300] cursor-pointer flex items-center gap-2 mb-3"
              >
            ...
            <div className="w-full sm:w-[50%] lg:w-[27%] pr-4 mb-6">
              ...
              <div className="flex gap-4 mb-5">
                ...
                <div className="flex flex-col justify-between">
                  <Link
                    href="/latest-news/1"
                    className="text-md sm:text-lg font-semibold cursor-pointer hover:text-[#EB3300] duration-200"
                  >
                    Finding the Best Value for Your Car
                  </Link>
                  <div className="flex items-center gap-2">
                    <FaRegUser className="text-[#EB3300]" />
                    <p className="text-[#8b8e95]">Post By Alan Walker</p>
                  </div>
                </div>
              </div>
              <div className="flex gap-4 mb-5">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <FaRegUser className="text-[#EB3300]" />
                    <p className="text-[#8b8e95]">Post By John Doe</p>
                  </div>
                </div>
              </div>
            </div>
